...
CREATE TABLE IF NOT EXISTS "DIRECTOR_FILM" (
	"DIRECTOR_FILM_ID" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	"DIRECTOR_ID" INTEGER NOT NULL,
	"FILM_ID" INTEGER NOT NULL,
	CONSTRAINT fk_director FOREIGN KEY ("DIRECTOR_ID") REFERENCES DIRECTOR("DIRECTOR_ID"),
	CONSTRAINT fk_film_director FOREIGN KEY ("FILM_ID") REFERENCES FILM("FILM_ID")
);
...
ALTER TABLE "DIRECTOR_FILM" ADD CONSTRAINT IF NOT EXISTS "DIRECTOR_FK" FOREIGN KEY (DIRECTOR_ID) REFERENCES "DIRECTOR"("DIRECTOR_ID") ON DELETE SET NULL ON UPDATE SET NULL;
ALTER TABLE "DIRECTOR_FILM" ADD CONSTRAINT IF NOT EXISTS "FILM_FK_DIRECTOR" FOREIGN KEY (FILM_ID) REFERENCES "FILM"("FILM_ID") ON DELETE SET NULL ON UPDATE SET NULL;